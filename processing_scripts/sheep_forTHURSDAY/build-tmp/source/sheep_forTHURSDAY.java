...
public class sheep_forTHURSDAY extends PApplet {
...
public void setup() {
  for (int i = 0; i<10;i++) {
    float r = random( 1, 10 );
    balls.add(new Ball((int) random( 0, noAnimalTypes-.0000001f ), 1, random( 0, sW ), random( 0, sH), r));
...
public void checkObjectCollision(ArrayList bList, ArrayList vList) {
...
class Ball{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sheep_forTHURSDAY" };
    if (passedArgs != null) {
